...
dev_script_path="/path/to/www/jvc-better-news/"

# nom du fichier principal du script
main_script_file="jvc-better-news.user.js"
...
gm_script_path="/home/<user>/.mozilla/firefox/<profile_name>/gm_scripts/JVC_Better_News/"
